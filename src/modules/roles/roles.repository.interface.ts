...
export interface RolesRepository {
  ...
  findAll(workspace: string, page?: number, limit?: number, name?: string): Promise<{ roles: RoleResponseDto[]; total: number }>;
  findById(id: string, workspace: string): Promise<RoleResponseDto | null>;
